...
from app.utilities import create_user, flash_and_redirect, get_user_by_username, is_valid_username
...
def register() -> Tuple[Response, int]:
    db = get_db()
    user_exists = get_user_by_username(db, request.form)
    if user_exists:
